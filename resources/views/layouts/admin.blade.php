...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/nucleo-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/nucleo-svg.css') }}">

    <link rel="stylesheet" href="{{ asset('admin/css/soft-ui-dashboard.css') }}">
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <img src="{{ asset('images/' . $settings[1]->value) }}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold"><br>
                @if (localePrefix() == '_en')
                    {{ $settings[2]->value }}
                @else
                    {{ $settings[3]->value }}
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{ __('app_settings') }}</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('supplier.index') }}">
                        ...
                        <span class="nav-link-text ms-1">{{ __('supplier') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('garage.index') }}">
                        ...
                        <span class="nav-link-text ms-1">{{ __('garage') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('vehicle.index') }}">
                        ...
                        <span class="nav-link-text ms-1">{{ __('truck') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('workshop.index') }}">
                        ...
                        <span class="nav-link-text ms-1">{{ __('workshop') }}</span>
                    </a>
                </li>
