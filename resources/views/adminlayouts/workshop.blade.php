...
@section('content')
    <div class="t-header">{{ __('workshop_management') }}</div>
    <br>
    <br>
    <br>
                ...
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td><a href="#" class="btn btn-primary btn-sm edit-garage" data-toggle="modal" data-target="#customModalTwo" data-id="{{ $d->id }}">{{ __('edit') }}</a>
                            ...
                            <form action="{{ route('workshop.destroy', $d->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-garage').click(function(e) {
                ...
                $.ajax({
                    url: '/workshop/' + id + '/edit',
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        $('#ups').attr('action', '/workshop/' + id);
